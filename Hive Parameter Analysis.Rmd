...
bee_param_df <- list.files(path="hive_data/heat_worker/", full.names = TRUE) %>% 
                lapply(read_csv, show_col_types = FALSE) %>% 
                bind_rows

write.csv(bee_param_df,"bee_data_isaac_heat_worker.csv",row.names = FALSE)
...
worker_bee_param <- read.csv("bee_data_isaac_heat_worker.csv") %>% mutate(type = "Worker") %>% select(-c(bhd,wha,qha))
queen_bee_param <- read.csv("bee_data_isaac_heat_queen.csv") %>% mutate(type = "Queen") %>% select(-c(bhd,wha,qha))
none_bee_param <- read.csv("bee_data_isaac_heat_none.csv") %>% mutate(type = "None")
