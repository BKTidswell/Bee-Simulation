...
hive_matrix_to_graph(hive,queen)
...
for(trial in 1:N_TRIALS){
  ...
  Count_Heat_Contents <- tibble(Brood = get_percent_in_heat(hive,BROOD),
                           Honey = get_percent_in_heat(hive,HONEY),
                           Pollen = get_percent_in_heat(hive,POLLEN),
                           Empty = get_percent_in_heat(hive,EMPTY))
  ...
  #24 hours in a day
    for(h in 1:24){
      ...
      Count_Heat_Contents <- Count_Heat_Contents %>% add_row(Brood = get_percent_in_heat(hive,BROOD),
                                                             Honey = get_percent_in_heat(hive,HONEY),
                                                             Pollen = get_percent_in_heat(hive,POLLEN),
                                                             Empty = get_percent_in_heat(hive,EMPTY))
...
write_csv(QUEENDF,"queen_pos_data.csv")
