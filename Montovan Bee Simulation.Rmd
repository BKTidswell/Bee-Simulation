...
New_Queen <- R6Class("New Queen",
                 public = list(
                   ...
                   move = function(){
                     ...
                     self$cur_X <- self$cur_X + cos(angle_move)
                     self$cur_Y <- self$cur_Y + sin(angle_move)
...
for(trial in 1:N_TRIALS){
  ...
  queen <- New_Queen$new(MAX_X/2,MAX_Y/2)
  ...
  av::av_encode_video(paste0(productPath,list.files(productPath, '*.png')), framerate = 10,
                      output = gsub("\\.","_",
                                   paste0("hive_videos/bee_video_D",DAYS,
                                      "_n",QUEEN_CELLS_PER_HOUR,
                                      "_rb",BROOD_RADIUS,
                                      "_rn",NECTER_CONSUMP_RAD,
                                      "_pph",POLLEN_RATIO,
                                      "_ph",HONEY_CONSUMPTION_RATIO,
                                      "_pp",POLLEN_CONSUMPTION_RATIO,
                                      "_k",K,
                                      ".mp4")))
}
